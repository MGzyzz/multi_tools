...
class StudentAPITests(BaseJWTAPITestCase):
    ...
    def setUp(self):
        ...
        self.group_response = self.client.post(self.group_url, data=self.group_data, **self.auth_headers(), format='json')
        ...
        self.student_response = self.client.post(self.student_url, data=self.student_data, **self.auth_headers(), format='json')
