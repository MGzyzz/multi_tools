import { Search, Filter, Users, Mail, Phone, TrendingUp, Loader2, Edit2, Trash2, MoreVertical, UserPlus } from 'lucide-react';
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="relative">
                    <button
                      onClick={(e) => { e.stopPropagation(); onToggleDropdown(student.id); }}
                    ...
                    {activeDropdown === student.id && (
                      <div className={`absolute right-0 mt-2 w-48 ${isDark ? 'bg-gray-800' : 'bg-white'} rounded-xl border ${isDark ? 'border-gray-700' : 'border-gray-200'} shadow-xl z-10`}>
                        <button
