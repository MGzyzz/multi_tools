    ...
    <div className="relative w-full h-full">
      ...
      <div
        className={`absolute inset-0 border-4 rounded-full transition-all duration-300 ${
          isProcessing ? 'border-blue-500 animate-spin' : 'border-green-500/50'
        }`}
        style={{
      ...
      <div
        className={`absolute inset-4 border-2 rounded-full transition-all duration-300 ${
          isProcessing ? 'border-purple-500' : 'border-green-500/30'
        }`}
        style={{
      ...
      {/* Main frame */}
      <div
        className={`absolute inset-8 border-4 rounded-3xl transition-all duration-300 ${
          isProcessing
          ...
          {scanProgress === 100 ? (
            ...
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${
                isProcessing ? 'bg-blue-500/20 animate-pulse' : 'bg-green-500/20'
              }`}
            >
              <Scan
                className={`w-6 h-6 transition-colors duration-300 ${
                  isProcessing ? 'text-blue-400' : 'text-green-400'
                }`}
              />
            </div>
          )}
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4">
          {/* present */}
          <div className={`${isDark ? 'bg-gray-800/50' : 'bg-white'} backdrop-blur-sm rounded-2xl p-4 sm:p-5 border ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="lg:col-span-2">
          <div className={`${isDark ? 'bg-gray-800/50' : 'bg-white'} backdrop-blur-sm rounded-2xl p-5 sm:p-6 border ${
            isDark ? 'border-gray-700' : 'border-gray-200'
          } shadow-lg`}>
              ...
              {!isScanning ? (
                ...
                <>
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-2 px-6 py-3 rounded-xl font-semibold cursor-pointer transition-all duration-300 ${
                      isProcessing
